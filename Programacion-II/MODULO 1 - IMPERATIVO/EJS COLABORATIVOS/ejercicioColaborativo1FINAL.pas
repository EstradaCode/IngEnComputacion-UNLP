program ejercicioColaborativo1FINAL;
type
...
procedure crearListaConArbol(a:arbol;var l:lista);
begin
  if(a<>nil) then begin
    crearListaConArbol(a^.HI,l);
    if(a^.dato.cant > 10) then begin
      agregarOrdenado(l,a^.dato.CodP)
    end;
    crearListaConArbol(a^.HD,l);
  end;
