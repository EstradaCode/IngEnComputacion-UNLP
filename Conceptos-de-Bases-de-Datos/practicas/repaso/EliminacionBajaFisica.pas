...
procedure eliminacionFisica1(var archivo:ArchMaestro, var nuevo:ArchMaestro); // marca los registros del archivo a eliminar y despues crea uno nuevo sin los marcados
var regm:plantas;
begin
...
procedure eliminacionFisica2(var archivo:ArchMaestro, codigo:integer); // el ultimo elemento del archivo se copia en el lugar del registro a borrar, luego se trunca el ultimo elemento para evitar duplicados
